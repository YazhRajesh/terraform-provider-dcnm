...
func resourceDCNMInventroyRead(d *schema.ResourceData, m interface{}) error {
	...
	for _, ip := range switchIps {
		...
		sGetMap := make(map[string]interface{})
...
// func checkSwitchDeploy(client *client.Client, fabric, serialNum string) error {
...
// 	log.Println("[DEBUG] End of Deployment of switches ")
// 	return nil
// }
